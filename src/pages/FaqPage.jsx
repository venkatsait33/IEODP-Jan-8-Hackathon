...
const FaqPage = () => {
    const faqs = [
        {
            ...
            answer:
                "IEODP (Intelligent Enterprise Operations & Decision Platform) is a unified enterprise platform to manage workflows, governance, compliance, and AI-assisted decision making across roles.",
        },
        {
            question: "Which roles are supported in the platform?",
            answer:
                "The platform supports Operations, Leadership, Management, Auditors, and Admin roles. Each role has permission-driven access and actions.",
        },
        {
            question: "How does the ticket workflow work?",
            answer:
                "Tickets are raised by Operations, reviewed by Leadership, acted upon by Management, and finally approved/rejected/reverified by Auditors. Each step is tracked with a full audit timeline.",
        },
        {
    ...
    return (
        <motion.div initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
                    variants={fadeIn}  className="max-w-5xl mx-auto px-4 py-10">
            <motion.h1 variants={fadeUp} className="text-3xl font-bold mb-6 text-center">
            ...
            <motion.div initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
                    variants={fadeIn} className="space-y-4">
                {faqs.map((faq, index) => (
